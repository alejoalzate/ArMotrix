  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved customer as @customer" do
        ...
        post :create, {:customer => { "document" => "invalid value" }}, valid_session
        assigns(:customer).should be_a_new(Customer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested customer" do
        ...
        Customer.any_instance.should_receive(:update_attributes).with({ "document" => "" })
        put :update, {:id => customer.to_param, :customer => { "document" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the customer as @customer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Customer.any_instance.stub(:save).and_return(false)
        put :update, {:id => customer.to_param, :customer => { "document" => "invalid value" }}, valid_session
        assigns(:customer).should eq(customer)
      end
